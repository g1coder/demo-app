...
import FeedbackForm from 'app/components/AnonymousLayout/ContactsPage/FeedbackForm';
...
const ContactsPage = () => {
  ...
  return (
    <StyledMainLayoutWrapper>
      <StyledBackground />
      <StyledContainer>
        <Grid container xs={12} justifyContent="space-between" columns={{xs: 1, md: 6, xl: 12}} spacing={2}>
          <Grid item xs={1} md={3} xl={4}>
            <Typography variant="h5" color="primary.dark" sx={{marginBottom: 3}}>
              Central Office
            </Typography>
            <Typography variant="body1" color="primary.dark">
              Nam eu mi eget velit vulputate tempor gravida quis massa. In malesuada condimentum ultrices. Sed et mauris
              a purus fermentum elementum. Sed tristique semper enim, et gravida orci iaculis et. Nulla facilisi.
            </Typography>
