...
import LoginForm, {IFormValues as ILoginFormValues} from 'pages/LoginPage/LoginForm';
import {
  StyledContainer,
  StyledFormContainer,
...
import LoginResetPasswordForm from 'pages/LoginPage/LoginResetPasswordForm';
